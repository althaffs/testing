...
#ifndef ARTIK_A710_PLATFORM_SENSORS_H_
#define ARTIK_A710_PLATFORM_SENSORS_H_

/*! \file artik_a710_platform_sensors.h
 *
 *  \brief Hardware specific definitions for the A710 platform sensors
 *
 */
...
static const artik_i2c_config hts221_humidity_config = {
	1, 1000, I2C_8BIT, HTS221_ADDR
};
static const artik_i2c_config cc3323e_config = {
	1, 1000, I2C_8BIT, CM3323E_ADDR
};
static const artik_i2c_config lps25hbtr_barometer_config = {
...
static const artik_spi_config k6ds3_xl_config = {
	2, 0, SPI_MODE0, 8, 1000000
};
static const artik_spi_config k6ds3_gyro_config = {
	2, 0, SPI_MODE0, 8, 1000000
};

/* Based upon Artik Sensor Board - Rev.1.0 */
static artik_sensor_config artik_api_a710_sensors[] = {

	{
		ARTIK_SENSOR_TEMPERATURE, (char *)"hts221_temp",
		(void *)&hts221_temp_config, &hts221_temp_sensor
	},
	{
		ARTIK_SENSOR_BAROMETER, (char *)"barometer",
		(void *)&lps25hbtr_barometer_config,
		&lps25hbtr_barometer_sensor
	},
	{
		ARTIK_SENSOR_HUMIDITY,
		(char *)"hts221_humidity",
		(void *)&hts221_humidity_config,
		&hts221_humidity_sensor
	},
	{
		ARTIK_SENSOR_LIGHT, (char *)"light",
		(void *)&cc3323e_config, &cm3323e_sensor
	},
	{
		ARTIK_SENSOR_HALL, (char *)"hall",
		(void *)&s5712ccdl1_config, &s5712ccdl1_sensor
	},
	{
		ARTIK_SENSOR_ACCELEROMETER,
		(char *)"k6ds3_xl",
		(void *)&k6ds3_xl_config,
		&k6ds3_xl_sensor
	},
	{
		ARTIK_SENSOR_GYRO,
		(char *)"gyro",
		(void *)&k6ds3_gyro_config,
		&k6ds3_gyro_sensor
	},
	{ ARTIK_SENSOR_NONE, NULL, NULL, NULL }
};
#endif /* ARTIK_A710_PLATFORM_SENSORS_H_ */
