...
typedef struct {
	...
	artik_i2c_id id;
	/*!
	 *  \brief maximum frequency allowed by the I2C chip
	 *         to address
	 */
	int frequency;
	/*!
...
typedef struct {
	 ...
	 *
	 *  \param[out] handle Handle tied to the requested
	 *              I2C instance returned by the function.
	 *  \param[in] config Configuration to apply to the
	 *             requested I2C instance.
	 *
	 *  \return S_OK on success, error code otherwise. The
	 *          function returns E_BUSY if the
	 *          requested ID/address pair has already been
	 *          requested
	 */
	 ...
	 *
	 *  \param[in] handle Handle tied to the requested I2C
	 ...
	 *             This handle is returned by the \ref request
	 *             function.
	 *  \param[out] buffer Array to be filled with the data read
	 *              from the I2C bus
	 *  \param[in] len Length of the array corresponding to the
	 ...
	 *
	 *  \param[in] handle Handle tied to the requested I2C instance
	 *             to write to.
	 *             This handle is returned by the \ref request
	 *             function.
	 *  \param[in] buffer Array containing the data to write to the
	 *             I2C bus
	 *  \param[in] len Length of the array corresponding to the number
	 *             of bytes to write
	 *
	 *  \return S_OK on success, error code otherwise
	 */
	 ...
	 *  \param[in] reg I2C internal register address to read the value
	 *             from
	 *  \param[out] buffer Array to be filled with the data read from the
	 *              register
	 ...
	 *
	 *  \param[in] handle Handle tied to the requested I2C instance to
	 *             be read.
	 *             This handle is returned by the \ref request function.
