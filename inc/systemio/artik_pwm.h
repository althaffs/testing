 ...
 *
 *  Type for specifying the polarity of the cycle
 *  duty of the PWM module.
 */
typedef enum {
...
typedef struct {
	...
	char *name;
	/*!
	 *  \brief Period of a duty cycle for the PWM
	 *         module.
	 */
	unsigned int period;
	/*!
	 *  \brief Frequency of a duty cycle for the
	 *         PWM module.
	 */
	unsigned int duty_cycle;
	/*!
	 *  \brief Polarity of a duty cycle (high/low)
	 *         for the PWM module.
	 */
	artik_pwm_polarity_t polarity;
	/*!
	 *  \brief Pointer to data for internal use by
	 *         the API.
	 */
	void *user_data;
 ...
 *
 *  Structure containing all the exposed operations
 *  exposed by the module to operate on a PWM instance
 */
typedef struct {
	/*!
	 *  \brief Request a PWM instance
	 *
	 *  \param[in,out] handle Handle tied to the
	 *                 newly requested PWM instance.
	 *  \param[in,out] config Configuration to apply
	 *                 to the requested PWM.
	 *
	 ...
	 *  \param[in] handle Handle tied to the requested
	 *             PWM instance to be released.
	 *             This handle is returned by the \ref
	 *             request function.
	 *
	 *  \return S_OK on success, error code otherwise
	 */
	 ...
	 *             This handle is returned by the \ref
	 *             request function.
	 *  \param[in] period Time in nanoseconds corresponding
	 *             to the full period (active and inactive
	 *             time)
	 *
	 *  \return S_OK on success, error code otherwise
	 */
	 ...
	 *
	 *  \param[in] handle Handle tied to the requested PWM
	 ...
	 *                    This handle is returned by the \ref
	 *                    request function.
	 *  \param[in] duty_cycle Time in nanoseconds corresponding
	 *             to the active time
