...
typedef struct {
	 ...
	 *
	 *  \param[out] handle Handle tied to the requested SPI
	 *              instance.
	 *  \param[in] config Configuration to apply to the
	 *             requested SPI instance.
	 *
	 ...
	 *
	 *  \param[in] handle Handle tied to the requested SPI
	 ...
	 *             This handle is returned by the \ref
	 *             request function.
	 *  \param[out] buffer Buffer filled with the data read
	 *              from the SPI bus.
	 *  \param[in] len Length of the buffer corresponding to
	 ...
	 *             to the SPI bus.
	 *  \param[in] len Length of the buffer corresponding to the
	 ...
	 *
	 *  \param[in] handle Handle tied to the requested SPI
	 *             instance to be read and write.
	 *             This handle is returned by the \ref request
	 *             function.
	 *  \param[in] tx_buf Buffer containing the data to send over
	 *             the SPI bus.
	 *  \param[out] rx_buf Preallocated buffer filled with the data
	 *              read during the SPI transaction.
	 *  \param[in] len Length in bytes of the transaction to perform.
